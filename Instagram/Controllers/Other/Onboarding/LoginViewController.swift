...
class LoginViewController: UIViewController {
    ...
    private func configureHeaderView(){
        // by default we should only have one subview.
    ...
    //function when three buttons are tapped
            ...
            DispatchQueue.main.async{
                if success{
                    ...
                    alert.addAction(UIAlertAction(title: "Dismiss",
                                                  style: .cancel,
                                                  handler: nil)) // can be nil since we are not going to do anything; just dismiss the alert
